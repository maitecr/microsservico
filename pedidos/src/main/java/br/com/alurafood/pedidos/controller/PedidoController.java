...
public class PedidoController {
    ...
    public String retornaPorta(@Value("${local.server.port}") String porta) {
        return String.format("Requisição respondida pela instância excutando na porta %s", porta);
    }
    ...
    //Método para fazer a atualização do status do pedido para pago no postman
    @PutMapping("/{id}/pago")
